...
$router->get('/sales/export-xlsx', [$admin, 'salesExportXlsx']);
$router->post('/sales/reports/generate', [$admin, 'generateSalesReport']);
$router->get('/sales/reports/{id}/download', [$admin, 'downloadSalesReport']);
$router->post('/sales/reports/{id}/resend', [$admin, 'resendSalesReport']);
